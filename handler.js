...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/56932786316) */
    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/KillzN/kattia-bot/master/src/avatar_contact.png';
          try {
